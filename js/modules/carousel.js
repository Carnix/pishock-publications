 ...
 * @property {string|null} [slideSelector=null] - CSS selector for the individual slide elements within the carousel.
 * @property {boolean} [enableAutoplay=true] - Whether to enable autoplay for the carousel.
...
export const JSCarousel = ({
	...
	/** @type {HTMLElement} The previous button element. */
	let prevBtn;
  
	/** @type {HTMLElement} The next button element. */
	let nextBtn;
	...
	/**
	 * Event handler for previous button clicks.
	 */
	const handlePrevBtnClick = () => moveSlide("prev");
  
	/**
	 * Event handler for next button clicks.
	 */
